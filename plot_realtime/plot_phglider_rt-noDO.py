...
Plot realtime pH glider data variables: seawater temperature, salinity, chlorophyll, pH reference
...
def main(args):
    ...
    for v in ['conductivity', 'temperature', 'sbe41n_ph_ref_voltage', 'salinity', chlvar]:
